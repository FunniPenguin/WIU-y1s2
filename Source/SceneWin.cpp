...
void SceneWin::Init()
{
	...
	camera.Init(glm::vec3(0, 0, 1), glm::vec3(0, 0, 0));
	...
	meshList[GEO_PLANE]->textureID = LoadTGA("Images//scenewin.tga");
...
void SceneWin::Render()
{
	...
	modelStack.Scale(0.15f, 0.15f, 0.f);
